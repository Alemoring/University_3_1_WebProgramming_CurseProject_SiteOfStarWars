...
<template>
  <div>
    <div v-for="item in fractions" class="fraction-item">
      <div>{{ item.name }}</div>
      <div>{{ item.periodInLive }}</div>
      <button
        class="btn btn-success"
        @click="onFractionEditClick(item)"
    ...
    <div class="col">
      <div class="form-floating">
        ...
        <input
          type="text"
          class="form-control"
          v-model="fractionToAdd.periodInLive"
          required
        />
            ...
            <div class="col">
              <div class="form-floating">
                <input
                  type="text"
                  class="form-control"
                  v-model="fractionToEdit.periodInLive"
                />
                <label for="floatingInput">Период существования</label>
              </div>
            </div>
